...
function wee_premium_render_settings_page() {
  ...
  ?>
  <div class="wrap">
    <h1><?php echo esc_html__('Wee Premium', 'wee-premium'); ?></h1>
    ...
    <form method="post" action="<?php echo esc_url(admin_url('admin-post.php')); ?>">
      ...
      <table class="form-table" role="presentation">
        <tbody>
          ...
          <?php endif; ?>
          <tr>
            <th colspan="2"><h2><?php echo esc_html__('WooCommerce Features', 'wee-premium'); ?></h2></th>
          </tr>
          <tr>
          ...
          <tr>
            <th colspan="2"><h2><?php echo esc_html__('Facebook Cart Integration', 'wee-premium'); ?></h2></th>
          </tr>
          <tr>
          ...
          <tr>
            <th colspan="2"><h2><?php echo esc_html__('Reviews Page', 'wee-premium'); ?></h2></th>
          </tr>
          <tr>
            ...
            <td>
              ...
              for ($i = 0; $i < 10; $i++) { // Fixed 10 slots
                ...
                <div class="review-row">
                  <p>
                    <label><?php echo esc_html__('Author', 'wee-premium') . ' ' . esc_html($i + 1); ?>:</label>
                    <input type="text" name="review_author[<?php echo esc_attr($i); ?>]" value="<?php echo esc_attr($review['author']); ?>">
                  </p>
                  <p>
                    <label><?php echo esc_html__('Rating', 'wee-premium') . ' ' . esc_html($i + 1); ?>:</label>
                  ...
                  <p>
                    <label><?php echo esc_html__('Review Text', 'wee-premium') . ' ' . esc_html($i + 1); ?>:</label>
